...
// ../../node_modules/chinese-conv/src/libs/tongwen-st.ts
var s_2_t = {
  "·": "‧",
  "―": "─",
  "‖": "∥",
...
// ../../node_modules/chinese-conv/src/libs/tongwen-ts.ts
var t_2_s = {
  "¯": "ˉ",
  "‥": "¨",
  "‧": "·",
...
function sify(text) {
  ...
  let $$text = isString ? text : "";
  $$text = ($$text == null ? void 0 : $$text.replace(/[^\x00-\xFF]/g, replaceFn2)) || "";
  return $$text;
}
...
// ../../node_modules/chinese-conv/src/tifyJson.ts
var tifyJson = (text) => {
...
//# sourceMappingURL=chinese-conv.js.map
